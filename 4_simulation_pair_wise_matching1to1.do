...
file open output using "4_output_sim_matched_pairwise_andcontrol.csv", write replace
...
stcox exp1   exp1 con1 con2 con3
local out1 =exp(_b[exp1])
  
stset dout , failure(outcome) 
stcox exp1 con1 con2 con3
local out1 =exp(_b[exp1])
